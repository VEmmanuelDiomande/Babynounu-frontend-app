...
// Tabs dynamiques pour les parents
const { state, configureParentTabs } = useTabHook();
const tabs = computed(() => {
  // Utiliser directement les onglets pour les parents
  const menuTabs = [...state.menuTabs]; // Copie pour éviter la mutation directe
  
  // Configurer les onglets spécifiques pour les parents
