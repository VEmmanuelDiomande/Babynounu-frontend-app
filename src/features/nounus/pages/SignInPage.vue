  ...
  <div class="flex-1 flex flex-col pb-8">
    ...
    <div class="text-center mb-6 px-6">
      <div class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-rose-100 text-rose-400 mb-4">
        ...
        <span class="font-love text-[10px] font-bold uppercase tracking-wider">Content de vous revoir</span>
      </div>
      <h1 class="font-love text-2xl font-bold text-gray-900 mb-2">
        Connectez-vous à <span class="text-rose-400">BabyNounu</span>
      </h1>
    ...
    >
      <div
        v-if="authStore.errors.login.message"
      ...
      >
        ...
        <p class="font-love text-sm text-red-700">{{ authStore.errors.login.message }}</p>
      </div>
    </Transition>
    ...
    <div class="bg-white rounded-[32px] shadow-sm p-6 mb-5">
      <div class="mb-5">
        <h2 class="font-love text-xl font-bold text-gray-900 mb-1">Connexion sécurisée</h2>
        <p class="font-love text-sm text-gray-400">Entrez vos identifiants pour continuer.</p>
      </div>
      ...
      <form @submit.prevent="handleSubmit" class="space-y-4">
          ...
          <div class="relative">
            ...
            <input
              ...
              :class="[
                ...
                authStore.errors.login.path === 'email' ? 'ring-2 ring-red-300' : ''
              ]"
            />
          </div>
        </div>
          ...
          <div class="relative">
            ...
            <input
              ...
              :class="[
                ...
                authStore.errors.login.path === 'password' ? 'ring-2 ring-red-300' : ''
              ]"
            />
            <button
              type="button"
        ...
        <div class="flex justify-end">
          <router-link :to="{ name: 'AUTH_FORGOT_PASSWORD' }" class="font-love text-sm text-teal-500 hover:text-teal-600 font-medium transition-colors">
            Mot de passe oublié ?
          </router-link>
        </div>
        ...
        >
          ...
          <span :class="{ 'opacity-0': state.loading }">SE CONNECTER</span>
        </button>
      </form>
    </div>
    ...
    <div class="flex items-center gap-4 mb-5">
      ...
      <span class="font-love text-[10px] text-gray-400 uppercase tracking-wider">ou continuer avec</span>
      <div class="flex-1 h-px bg-rose-200"></div>
    </div>
    ...
    <p class="text-center font-love text-sm text-gray-500 mb-6">
      Nouveau sur BabyNounu ?
      <router-link :to="{ name: 'AUTH_SIGN_UP' }" class="text-rose-400 hover:text-rose-500 font-semibold transition-colors underline">
        Créer un compte
      </router-link>
    </p>
